...
const navigation = {
  ...
  social: [
    {
      name: 'Instagram',
      href: 'https://instagram.com/taylorcollection',
      icon: Instagram,
    },
    {
      name: 'Twitter',
      href: 'https://twitter.com/taylorcollection',
      icon: Twitter,
    },
    {
      name: 'Facebook',
      href: 'https://facebook.com/taylorcollection',
      icon: Facebook,
    },
    {
      name: 'YouTube',
      href: 'https://youtube.com/taylorcollection',
      icon: Youtube,
    },
  ],
}
        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
          <div className="flex items-center justify-between">
            <p className="text-xs leading-5 text-gray-400">
              &copy; 2024 Taylor Collection. All rights reserved.
            </p>
